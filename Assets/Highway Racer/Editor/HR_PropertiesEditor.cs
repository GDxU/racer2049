...
//	{
//		ScriptableObjectUtility.CreateAsset<HR_HighwayRacerProperties> ();
//	}

//	[MenuItem("Highway Racer/General Settings2")]
//	static void GeneralSettings(){
//
//		Selection.activeObject = Resources.Load("HR_Assets/HR_HighwayRacerProperties") as HR_HighwayRacerProperties;
//		//EditorWindow.GetWindow(typeof(HR_PropertiesEditor));
//
//	}
	...
	public override void OnInspectorGUI (){
		...
		prop._defaultFlares = EditorGUILayout.ToggleLeft("Flares Enabled By Default", prop._defaultFlares, GUILayout.ExpandWidth(true));
	...
	void ResetToDefaults(){
		...
		prop._minimumCollisionForGameOver = 15;
		prop._defaultBodyColor = Color.red + (Color.green / 2f);

		prop._defaultBloom = true;
		prop._defaultHQLights = true;
		prop._defaultFlares = true;
